...
void WolfDraw(int x, int y)
    ...
    POINT wolf[] = { {x-90, y-10}, {x-150, y+40}, {x-120, y+70}, {x-30, y+50}, {x-30, y+90}, {x, y+80}, {x+70, y+100}, {x+80, y+80}, {x+120, y+80}, {x+110, y+40}, {x+140, y+40}, {x+130, y}, {x+150, y}, {x+120, y-30}, {x+100, y-40}, {x+120, y-40}, {x+80, y-50}, {x+90, y-60}, {x+60, y-80}, {x+70, y-90}, {x, y-110}, {x-10, y-120}, {x-30, y-130}, {x-30, y-110}, {x-20, y-90}, {x-50, y-90}, {x-60, y-80}, {x-70, y-100}, {x-90, y-110}, {x-90, y-80}, {x-80, y-70}, {x-100, y-30} };
    txPolygon (wolf, 32);
...
void HareDraw(int x, int y)
    ...
    POINT hare[] = { {x, y}, {x+10, y+50}, {x+20, y+50}, {x+10, y+30}, {x+10, y}, {x+20, y-10}, {x+30, y-10}, {x+40, y-20}, {x+20, y-40}, {x+10, y-70}, {x, y-90}, {x-10, y-70}, {x+10, y-40}, {x-10, y-20}, {x-60, y}, {x-70, y+30}, {x-80, y+20}, {x-80, y+30}, {x-60, y+50}, {x-10, y+50}, {x-20, y+40}, {x-30, y+40} };
    txPolygon (hare, 22);
...
void HomeDraw(int x, int y)
    ...
    txSetColor (TX_RED, 5);
    POINT home1[] = { {x+80, y+200}, {x+80, y+220}, {x, y+240}, {x+90, y+230}, {x+100, y+260}, {x+110, y+230}, {x+200, y+240}, {x+120, y+220}, {x+120, y+200} };
    txPolygon (home1, 9);
    txSetColor (TX_YELLOW);
    POINT home2[] = { {x, y}, {x+100, y-95}, {x+200, y} };
    txPolygon (home2, 3);
    txTextOut (x+35, y+15, "–Œ—œŒ“–≈¡Õ¿ƒ«Œ–");
    txSetFillColor (TX_BLACK);
...
void PigDraw(int x, int y)
    ...
    POINT pig[] = { {x, y}, {x, y-5}, {x+5, y-5}, {x+15, y-10}, {x+20, y-20}, {x+30, y-25}, {x+25, y-20}, {x+30, y-20}, {x+30, y-15}, {x+32, y-20}, {x+45, y-15}, {x+50, y-10}, {x+75, y-10}, {x+90, y+5}, {x+80, y}, {x+80, y+15}, {x+75, y+15}, {x+75, y+25}, {x+70, y+25}, {x+70, y+15}, {x+60, y+15}, {x+40, y+15}, {x+35, y+20}, {x+35, y+25}, {x+30, y+25}, {x+30, y+15}, {x+25, y+10}, {x+15, y+5}, {x+5, y+5}, {x+15, y} };
    txPolygon (pig, 30);
    }
